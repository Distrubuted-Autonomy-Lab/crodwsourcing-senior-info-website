...
- **Touch target size.** WCAG 2.1 Success Criterion 2.5.5 sets 44×44 CSS pixels as a minimum. Our rule is 48×48, and we specify 56 pixels of height for primary action buttons.
