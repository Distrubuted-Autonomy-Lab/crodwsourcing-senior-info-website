...
**Carebot Caregiver Resource Directory**
...
*[Screenshot: Home page showing the Submit a Resource button]*
...
*[Screenshot: Full submission form with four sections]*
...
*[Screenshot: Contact section with privacy note]*
...
*[Screenshot: Thank-you page after submission]*
...
*[Screenshot: Similarity search with example results]*
...
1. Refresh the page by pressing F5, or by closing the browser tab and opening the website again.
2. Check that your internet connection is working by trying another website.
3. Try a different browser. Chrome and Safari both work.
4. Try again in an hour. Sometimes the website is being updated.
